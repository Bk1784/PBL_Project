...
<body class="flex flex-col justify-center items-center h-screen bg-gray-200 m-0">
    ...
    <form action="{{ route('customer.forgot_password.submit') }}" method="post"
        class="w-full max-w-md flex justify-center">
        @csrf
        <div class="flex bg-white rounded-2xl shadow-md overflow-hidden w-[600px] mt-8 items-center justify-center">
            <div class="w-1/2 p-5 text-center">
                <h2 class="text-xl font-bold mb-5">Forgot Password</h2>
                ...
                <div class="flex items-center border-b border-gray-300 p-2">
                    ...
                    <input class="outline-none w-full p-2 bg-transparent" type="email" name="email" placeholder="Email"
                        required>
                </div>
                <button type="submit"
                    class="bg-gray-300 text-black font-bold py-3 px-6 rounded-full w-full mt-4 hover:bg-gray-400"> Reset
                    Link </button>
            </div>
