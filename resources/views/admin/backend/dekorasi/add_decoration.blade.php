...
<div class="bg-white text-gray-800 p-6 text-sm rounded-lg shadow-md mt-6 border border-gray-300 w-full">
    ...
    <h3 class="text-xl font-bold text-gray-800 mb-4">Add Decoration</h3>

    <form id="product-form" action="{{ route('admin.store.decoration') }}" method="POST" enctype="multipart/form-data">
        @csrf
        ...
        <div class="flex flex-col md:flex-row gap-6">
            <!-- Bagian Foto Decoration -->
            <div class="w-full md:w-1/3 text-center">
                <img id="productPreview" src="#" alt="Decoration Image"
...
$(document).ready(function() {
    ...
    $("#product-form").validate({
        ...
        messages: {
            ...
            image: {
                required: "Gambar dekorasi wajib diupload."
            }
        },
        errorElement: "span",
