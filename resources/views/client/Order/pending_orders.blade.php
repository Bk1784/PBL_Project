            ...
            <tbody>
                ...
                @else
                    ...
                    <tr class="hover:bg-gray-100">
                        ...
                        <td class="p-3 border-b border-gray-200">
                            <form action="{{ route('client.pesanan.execute', $order->id) }}" method="POST" class="execute-order-form" data-order-items="{{ $order->orderItems->toJson() }}">
                                @csrf
                ...
                htmlContent += `
                    <div class="flex items-center mb-2">
                        <div>
                            ...
                            <p>Qty: ${item.qty} | Harga: Rp ${item.price.toLocaleString()}</p>
                        </div>
                    </div>
                `;
            });
