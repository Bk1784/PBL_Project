    ...
    <div class="overflow-x-auto">
        <table class="w-full border-collapse">
            ...
            <tbody>
                @if($orders->isEmpty())
                    <tr>
                        <td colspan="7" class="text-center py-4 text-gray-500">Tidak ada pesanan dikirim.</td>
                    </tr>
                @else
                    ...
                    <td class="p-3 border-b border-gray-200">
                        <form action="{{ route('client.pesanan.complete', $order->id) }}" method="POST" class="complete-order-form" data-order-items="{{ $order->orderItems->toJson() }}">
                            @csrf
