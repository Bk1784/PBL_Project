            ...
            <div class="w-1/2 p-6 text-center">
                ...
                <div class="space-y-3">
                    <div class="flex items-center border-b border-gray-300 py-2">
                        ...
                        <input type="text" name="name" placeholder="Nama Toko" required class="w-full border-none focus:outline-none p-2">
                    </div>
                    <div class="flex items-center border-b border-gray-300 py-2">
                        <i class="fas fa-phone text-gray-600 mr-3"></i>
                        <input type="text" name="phone" placeholder="Nomor HP" required class="w-full border-none focus:outline-none p-2">
                    </div>
                    <div class="flex items-center border-b border-gray-300 py-2">
                        <i class="fas fa-map-marker-alt text-gray-600 mr-3"></i>
                        <input type="text" name="address" placeholder="Alamat" required class="w-full border-none focus:outline-none p-2">
                    </div>
                    <div class="flex items-center border-b border-gray-300 py-2">
                ...
                <button type="submit" class="bg-gray-300 text-black font-bold py-3 rounded-xl w-full mt-4 hover:bg-gray-400">Submit</button>
            </div>
